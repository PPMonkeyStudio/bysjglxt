...
function evaluate_tutor() {
	...
	xhr.onreadystatechange = function() {
		...
		if (xhr.readyState == 4) {
			if (xhr.status == 200) {
				...
				textarea_0.id = 'evaluate_tutor_id';
				textarea_0.style = "display:none;"
				textarea_0.innerHTML = evaluate_tutor.evaluate_tutor_id;
				...
				new_td = document.createElement("td");
				new_td.style = "text-align: center;";
				switch (evaluate_tutor.evaluate_tutor_grade_foreign_language) {
				case 0: {
					new_td.innerHTML = '<select onchange="change_evaluate_tutor_grade_total()"  class="form-control" id="evaluate_tutor_grade_foreign_language" >'
							+ '<option value="0" selected="selected">0</option>'
							+ '<option value="1">1</option>'
							+ '<option value="2">2</option>'
							+ '<option value="3">3</option>'
				...
				new_td = document.createElement("td");
				new_td.style = "text-align: center;";
				switch (evaluate_tutor.evaluate_tutor_grade_computer) {
				case 0: {
					new_td.innerHTML = '<select onchange="change_evaluate_tutor_grade_total()"  class="form-control" id="evaluate_tutor_grade_computer" >'
							+ '<option value="0" selected="selected">0</option>'
							+ '<option value="1">1</option>'
							+ '<option value="2">2</option>'
							+ '<option value="3">3</option>'
				...
				new_td = document.createElement("td");
				new_td.style = "text-align: center;";
				switch (evaluate_tutor.evaluate_tutor_grade_innovate) {
				case 0: {
					new_td.innerHTML = '<select onchange="change_evaluate_tutor_grade_total()"  class="form-control" id="evaluate_tutor_grade_innovate" >'
							+ '<option value="0" selected="selected">0</option>'
							+ '<option value="1">1</option>'
							+ '<option value="2">2</option>'
							+ '<option value="3">3</option>'
				...
				new_td = document.createElement("td");
				new_td.style = "text-align: center;";
				switch (evaluate_tutor.evaluate_tutor_grade_analysis) {
				case 0: {
					new_td.innerHTML = '<select onchange="change_evaluate_tutor_grade_total()"  class="form-control" id="evaluate_tutor_grade_analysis" >'
							+ '<option value="0" selected="selected">0</option>'
							+ '<option value="1">1</option>'
							+ '<option value="2">2</option>'
							+ '<option value="3">3</option>'
				...
				new_td = document.createElement("td");
				new_td.style = "text-align: center;";
				switch (evaluate_tutor.evaluate_tutor_grade_chart) {
				case 0: {
					new_td.innerHTML = '<select onchange="change_evaluate_tutor_grade_total()"  class="form-control" id="evaluate_tutor_grade_chart" >'
							+ '<option value="0" selected="selected">0</option>'
							+ '<option value="1">1</option>'
							+ '<option value="2">2</option>'
							+ '<option value="3">3</option>'
				...
				new_td = document.createElement("td");
				new_td.style = "text-align: center;";
				switch (evaluate_tutor.evaluate_tutor_grade_practicability) {
				case 0: {
					new_td.innerHTML = '<select onchange="change_evaluate_tutor_grade_total()"  class="form-control" id="evaluate_tutor_grade_practicability" >'
							+ '<option value="0" selected="selected">0</option>'
							+ '<option value="1">1</option>'
							+ '<option value="2">2</option>'
							+ '<option value="3">3</option>'
				...
				new_td = document.createElement("td");
				new_td.style = "text-align: center;";
				switch (evaluate_tutor.evaluate_tutor_grade_normalization) {
				case 0: {
					new_td.innerHTML = '<select onchange="change_evaluate_tutor_grade_total()"  class="form-control" id="evaluate_tutor_grade_normalization" >'
							+ '<option value="0" selected="selected">0</option>'
							+ '<option value="1">1</option>'
							+ '<option value="2">2</option>'
							+ '<option value="3">3</option>'
				...
				aSave.href='####';
				aSave.onclick = Save_evaluate_tutor
				aSave.text='提交更新';
	...
	xhr
			.open("POST",
					"/bysjglxt/graduationProject/GraduationProjectManagement_get_EvaluateTutor");
	xhr.send(formData);
}

function change_evaluate_tutor_grade_total() {
	var evaluate_tutor_grade_total = document
			.getElementById("evaluate_tutor_grade_total");
	var total = parseInt(document
			.getElementById("evaluate_tutor_grade_training_objective").value)
			+ parseInt(document
					.getElementById("evaluate_tutor_grade_difficulty").value)
			+ parseInt(document.getElementById("evaluate_tutor_grade_workload").value)
			+ parseInt(document.getElementById("evaluate_tutor_grade_bind").value)
			+ parseInt(document
					.getElementById("evaluate_tutor_grade_comprehensive").value)
			+ parseInt(document
					.getElementById("evaluate_tutor_grade_reference").value)
			+ parseInt(document
					.getElementById("evaluate_tutor_grade_experimental_design").value)
			+ parseInt(document
					.getElementById("evaluate_tutor_grade_computing").value)
			+ parseInt(document
					.getElementById("evaluate_tutor_grade_foreign_language").value)
			+ parseInt(document.getElementById("evaluate_tutor_grade_computer").value)
			+ parseInt(document.getElementById("evaluate_tutor_grade_innovate").value)
			+ parseInt(document.getElementById("evaluate_tutor_grade_analysis").value)
			+ parseInt(document.getElementById("evaluate_tutor_grade_chart").value)
			+ parseInt(document
					.getElementById("evaluate_tutor_grade_instructions").value)
			+ parseInt(document
