...
function List_Student_By_PageAndSearch(pageIndex) {
			...
			if (xhr.status == 200) {
				...
				/*	new_td = document.createElement("td");
					...
					if (student_json.list_StudentInformationDTO[num].bysjglxtStudentBasic != undefined
						...
						new_td.innerHTML = student_json.list_StudentInformationDTO[num].bysjglxtStudentBasic.student_basic_phone;
					} else {
						new_td.innerHTML = '无';
					}
					new_td = document.createElement("td");
					...
					if (student_json.list_StudentInformationDTO[num].bysjglxtStudentBasic != undefined
						...
						new_td.innerHTML = student_json.list_StudentInformationDTO[num].bysjglxtStudentBasic.student_basic_qq;
					} else {
						new_td.innerHTML = '无';
					}
					new_td = document.createElement("td");
					...
					if (student_json.list_StudentInformationDTO[num].bysjglxtStudentBasic != undefined
						...
						new_td.innerHTML = student_json.list_StudentInformationDTO[num].bysjglxtStudentBasic.student_basic_college;
					} else {
						new_td.innerHTML = '无';
					}
					new_td = document.createElement("td");
	...
	xhr.open("POST","/bysjglxt/student/StudentInformationManagement_ListStudentByPageAndSearch");
