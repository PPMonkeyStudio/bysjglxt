				...
				<div style="height: 34px;">
					...
					<div class="input-group" style="width: 300px; float: right;">
						<input id="input_search" class="form-control"
							oninput="List_MyTopic_By_PageAndSearch(1)" type="text"> <span
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button class="btn btn-default" id="button_updateTopic"
						onclick="Update_Topic()" style="float: right; margin: 0 10px;">
						<i class="fa fa-check"></i> 保存
					</button>
					<button class="student_control btn btn-default"
						onclick="drop_Topic()" style="float: right; margin: 0 10px;">
						<i class="fa fa-exclamation-triangle"></i> 退选
					</button>
				</div>
			</div>
		</div>
