				...
				<div style="width: 500px; margin: 0 auto;">
					...
					<div class="progress progress-xs">
						<div id="bar_TopicCurrentProcess"
							class="progress-bar progress-bar-success" role="progressbar"></div>
					</div>
				</div>
				<hr>
				...
				<div style="height: 34px;">
					...
					<div class="input-group" style="width: 300px; float: right;">
						<input id="input_search" class="form-control"
							oninput="List_Topic_By_PageAndSearch(1)" type="text"> <span
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button class="student_control btn btn-default"
						...
						<i class="fa fa-check"></i> 选题
					</button>
					<button class="student_control btn btn-default"
						id="button_selectTopic_early" onclick="studentSelectTopic_early()"
						style="float: right; margin: 0 10px;">
						<i class="fa fa-check"></i> 提前选题
					</button>
				</div>
			</div>
		</div>
