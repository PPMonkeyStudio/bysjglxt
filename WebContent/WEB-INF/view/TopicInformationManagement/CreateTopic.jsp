		...
		<div class="panel" style="width: 900px; margin: 20px auto;">
			...
			<div class="panel-body">
				<table id="" class="table table-bordered  "
					style="text-align: center; width: 840px; margin: 0 auto;">
					<tbody>
						<tr>
							<th>课题中文名称</th>
							<td>
							...
							<th>协助教师姓名</th>
							<td>
								<input id="topic_invite_teacher_name" class="form-control">
							</td>
						</tr>
						<tr>
							<th>课题英文名称</th>
							...
							<th>协助教师性别</th>
							<td>
								<select id="topic_invite_teacher_sex" class="form-control"
									style="width: auto;">
						...
						<tr>
							<th>课题实现要求</th>
							<td>
								<textarea id="topic_requirement" class="form-control" ></textarea>
							</td>
							<th>协助教师工作单位</th>
							<td>
								<input id="topic_invite_teacher_unitname" class="form-control">
							</td>
						</tr>
						<tr>
							<th>课题来源</th>
							<td>
								<select id="topic_source" class="form-control"
									style="width: auto;">
							...
							<th>协助教师职称</th>
							<td>
								<input id="topic_invite_teacher_technicalitle"
									class="form-control">
							</td>
						</tr>
						<tr>
							...
							<th>协助教师职务</th>
							<td>
								<input id="topic_invite_teacher_duties" class="form-control">
							</td>
						</tr>
						<tr>
							<th>课题备注</th>
							<td>
								<textarea id="topic_remark" class="form-control" style=""></textarea>
							</td>
						</tr>
					</tbody>
				</table>
