		...
		<div class="panel" style="width: 95%; margin: 20px auto;">
			...
			<table id="" class="table table-hover table-bordered  "
				...
				<tbody>
					<tr>
						<th>课题中文名称</th>
						<td><input id="topic_name_chinese" class="form-control" style="width: 500px;"></td>
					</tr>
					<tr>
						<th>课题英文名称</th>
						<td><input id="topic_name_english" class="form-control" style="width: 500px;"></td>
					</tr>
					<tr>
						<th>课题实现要求</th>
					...
					<tr>
						<th>课题来源</th>
						<td><select id="topic_source" class="form-control" style="width: auto;">
					...
					<tr>
						<th>课题性质</th>
						<td><select id="topic_type" class="form-control" style="width: auto;">
