		...
		<div id="navbar-menu">
			<ul class="nav navbar-nav navbar-left" style="margin: 0 0 0 30px">
				...
				<li class="leader_control dropdown" style="float: left;"><a
					href="#" class="dropdown-toggle" data-toggle="dropdown"> <span>信息</span>
				...
				<li class="dropdown" style="float: left;"><a
					...
					class="dropdown-toggle"> <span>课题</span> <!-- <i class="icon-submenu lnr lnr-chevron-down"></i> -->
				</a></li>
				<!--  -->
				<li class="dropdown" style="float: left;"><a href="#"
					class="dropdown-toggle" data-toggle="dropdown"> <span>流程</span>
						<i class="icon-submenu lnr lnr-chevron-down"></i>
				</a>
					<ul class="dropdown-menu">
						<li><a
						...
						<li><a href="<%=basePath%>process/ProcessManagement_MyTask">我的任务</a>
						</li>
					</ul></li>
				<!--  -->
				<li class="dropdown" style="float: left;"><a href="#"
					class="dropdown-toggle" data-toggle="dropdown"> <span>毕业设计</span>
						<i class="icon-submenu lnr lnr-chevron-down"></i>
				</a>
					<ul class="dropdown-menu">
