...
public class bysjglxt_topic_invite_teacher {

	private String topic_invite_teacher_id;
	private String topic_invite_teacher_name;
	...
	public void setTopic_invite_teacher_id(String topic_invite_teacher_id) {
		this.topic_invite_teacher_id = topic_invite_teacher_id;
	}

	public String getTopic_invite_teacher_name() {
		return topic_invite_teacher_name;
	}

	public void setTopic_invite_teacher_name(String topic_invite_teacher_name) {
		this.topic_invite_teacher_name = topic_invite_teacher_name;
	}

	public String getTopic_invite_teacher_sex() {
		return topic_invite_teacher_sex;
	}

	public void setTopic_invite_teacher_sex(String topic_invite_teacher_sex) {
		this.topic_invite_teacher_sex = topic_invite_teacher_sex;
	}

	public String getTopic_invite_teacher_unitname() {
		return topic_invite_teacher_unitname;
	}

	public void setTopic_invite_teacher_unitname(String topic_invite_teacher_unitname) {
		this.topic_invite_teacher_unitname = topic_invite_teacher_unitname;
	}

	public String getTopic_invite_teacher_technicalitle() {
		return topic_invite_teacher_technicalitle;
	}

	public void setTopic_invite_teacher_technicalitle(String topic_invite_teacher_technicalitle) {
	...
	public String getTopic_invite_teacher_gmt_modify() {
		return topic_invite_teacher_gmt_modify;
	}
