...
public class bysjglxt_defence {
	...
	private int defence_grade_writing;
	private int defence_grade_normalization;
	private int defence_grade_complete;
	private int defence_grade_technology;
	private int defence_grade_practicability;
	private int defence_grade_appearance;
